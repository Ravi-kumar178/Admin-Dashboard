...
import { Legend, PolarAngleAxis, PolarGrid,Tooltip, PolarRadiusAxis, Radar, RadarChart, ResponsiveContainer } from 'recharts'

const customerSegmantationData = [
    {subject:"Engagement", A:120 ,B:120 ,fullMark:150},
  ...
  return (
    ...
    >
     ...
     <div style={{width:"100%", height:300}}>
        <ResponsiveContainer>
            <RadarChart cx={'50%'} cy={'50%'} outerRadius={'80%'} data={customerSegmantationData}>
...
export default CustomerSegmantation