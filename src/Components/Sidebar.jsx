...
const SIDEBAR_ITEMS = [
  ...
  {
    name:"Users", icon: User, color:"#EC4899", path:"/users"
  },
  {
  ...
  {
    name:"Analytics", icon: TrendingUp, color:"", path:"/analytics"
  },
  {
...
const Sidebar = () => {
  ...
  return (
    <motion.div
     className={`z-10 relative transition-all duration-300 ease-in-out flex-shrink-0 ${isSidebarOpen?"w-64":"w-20"}`}
