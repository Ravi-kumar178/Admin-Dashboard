...
import { Legend,BarChart,Bar, CartesianGrid, Cell, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts'
...
const UserActivityHeapMap = () => {
    return (
        ...
        <h2 className='text-lg font-medium mb-4 text-gray-400'>Sales Activity HeatMap</h2>
...
export default UserActivityHeapMap